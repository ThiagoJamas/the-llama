...
let story = `Upon visiting ${place}, you were attacked by a giant, rabid, mutant ${animal.toLowerCase()}.<p>Suddenly, ${famousPerson} came to your aid and gave you a magical ${magicObject.toLowerCase()}. With it you, then, transformed the evil ${animal.toLowerCase()} into a delicious ${favoriteFood.toLowerCase()} which you and ${famousPerson} savored along with lots of ${favoriteDrink.toLowerCase()}.</p><p>You, ${name}, are a <strong>Hero</strong>!</p>` 
